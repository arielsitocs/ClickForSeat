...
export default function Home() {
  ...
  return (
    <div className="flex flex-row flex-col bg-black w-full min-h-screen px-3 py-4 md:px-4 md:py-10 md:gap-6 gap-2">
      <ActiveFunctions shows={Shows} setSelectedShow={setSelectedShow} selectedShow={selectedShow} />
